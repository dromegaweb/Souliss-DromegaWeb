...
*                 22 Dicembren 2015 - stesura I/O necessari
*                 
*
****************************************************************************/
...
void setup()
{
  ...
  pinMode(10, OUTPUT);    //Valvola irrigazione 01
  pinMode(11, OUTPUT);    //Valvola irrigazione 02
  pinMode(12, OUTPUT);    //Ventola scambio termico
  pinMode(13, OUTPUT);    //Ventola anti umidità
